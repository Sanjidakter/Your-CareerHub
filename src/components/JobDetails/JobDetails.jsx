...
const handleAddToCart = singleJobData =>{
    const newCart = [...cart,singleJobData];
    setCart(newCart);
}
    ...
    <div>
      ...
      <div className="job-description">
        ...
        <p>
          ...
          designing and creating engaging and effective interfaces for software
          and web applications. This includes designing the layout, visual
      ...
      <div className="job-details">
        ...
        <hr />
        <p>
          Salary : <span style={{ color: "#757575" }}>{singleJobData.salary}</span>
        </p>
        <p>
          Job Title :{" "}
          <span style={{ color: "#757575" }}>{singleJobData.job_position}</span>
        </p>
